    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExercicioObjetivoFisico", x => new { x.ExercicioId, x.ObjetivoFisicoId });
                    table.ForeignKey(
                        name: "FK_ExercicioObjetivoFisico_Exercicio_ExercicioId",
                        column: x => x.ExercicioId,
                        principalTable: "Exercicio",
                        principalColumn: "ExercicioId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExercicioObjetivoFisico_ObjetivoFisico_ObjetivoFisicoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Nome = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProfissionalSaudeId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProblemaSaude_ProfissionalExecutante_ProfissionalExecutanteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExercicioTipoExercicio", x => new { x.ExercicioId, x.TipoExercicioId });
                    table.ForeignKey(
                        name: "FK_ExercicioTipoExercicio_Exercicio_ExercicioId",
                        column: x => x.ExercicioId,
                        principalTable: "Exercicio",
                        principalColumn: "ExercicioId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExercicioTipoExercicio_TipoExercicio_TipoExercicioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UtenteGrupo7Id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UtenteGrupo7Id1 = table.Column<int>(type: "int", nullable: false),
                    ExercicioId = table.Column<int>(type: "int", nullable: false),
                    PlanoExerciciosId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HistoricoAtividades_Exercicio_ExercicioId",
                        column: x => x.ExercicioId,
                        principalTable: "Exercicio",
                        principalColumn: "ExercicioId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistoricoAtividades_PlanoExercicios_PlanoExerciciosId",
                        column: x => x.PlanoExerciciosId,
                        principalTable: "PlanoExercicios",
                        principalColumn: "PlanoExerciciosId");
                    table.ForeignKey(
                        name: "FK_HistoricoAtividades_UtenteGrupo7_UtenteGrupo7Id1",
                        column: x => x.UtenteGrupo7Id1,
                        principalTable: "UtenteGrupo7",
                        principalColumn: "UtenteGrupo7Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PlanoExercicioExercicio",
                columns: table => new
                {
                    PlanoExerciciosId = table.Column<int>(type: "int", nullable: false),
                    ExercicioId = table.Column<int>(type: "int", nullable: false),
                    Concluido = table.Column<bool>(type: "bit", nullable: false),
                    PesoUsado = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanoExercicioExercicio", x => new { x.PlanoExerciciosId, x.ExercicioId });
                    table.ForeignKey(
                        name: "FK_PlanoExercicioExercicio_Exercicio_ExercicioId",
                        column: x => x.ExercicioId,
                        principalTable: "Exercicio",
                        principalColumn: "ExercicioId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanoExercicioExercicio_PlanoExercicios_PlanoExerciciosId",
                        column: x => x.PlanoExerciciosId,
                        principalTable: "PlanoExercicios",
                        principalColumn: "PlanoExerciciosId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExercicioObjetivoFisico_ObjetivoFisicoId",
                table: "ExercicioObjetivoFisico",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExercicioTipoExercicio_TipoExercicioId",
                table: "ExercicioTipoExercicio",
                column: "TipoExercicioId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoAtividades_ExercicioId",
                table: "HistoricoAtividades",
                column: "ExercicioId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoAtividades_PlanoExerciciosId",
                table: "HistoricoAtividades",
                column: "PlanoExerciciosId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoAtividades_UtenteGrupo7Id1",
                table: "HistoricoAtividades",
                column: "UtenteGrupo7Id1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanoExercicioExercicio_ExercicioId",
                table: "PlanoExercicioExercicio",
                column: "ExercicioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProblemaSaude_ProfissionalExecutanteId",
                table: "ProblemaSaude",
