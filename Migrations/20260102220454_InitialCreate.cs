    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoricoAtividadeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoAtividades", x => x.HistoricoAtividadeId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistoricoAtividades_UtenteGrupo7_UtenteGrupo7Id",
                        column: x => x.UtenteGrupo7Id,
                        principalTable: "UtenteGrupo7",
                        principalColumn: "UtenteGrupo7Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoricoAtividades_UtenteGrupo7Id",
                table: "HistoricoAtividades",
                column: "UtenteGrupo7Id");
