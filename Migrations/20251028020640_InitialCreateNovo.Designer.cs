...
namespace HealthWellbeing.Migrations
{
    ...
    [Migration("20251028020640_InitialCreateNovo")]
    partial class InitialCreateNovo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeneficioTipoExercicio", b =>
                {
                    ...
                    b.Property<int>("TiposExercicioTipoExercicioId")
                        .HasColumnType("int");

                    b.HasKey("BeneficiosBeneficioId", "TiposExercicioTipoExercicioId");

                    b.HasIndex("TiposExercicioTipoExercicioId");

                    b.ToTable("BeneficioTipoExercicio", (string)null);
                });
            ...
            modelBuilder.Entity("BeneficioTipoExercicio", b =>
                {
                    ...
                    b.HasOne("HealthWellbeing.Models.TipoExercicio", null)
                        .WithMany()
                        .HasForeignKey("TiposExercicioTipoExercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
