    ...
    public partial class att : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FoodHabitsPlanId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    GoalId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodHabitsPlan", x => x.FoodHabitsPlanId);
                    table.ForeignKey(
                        name: "FK_FoodHabitsPlan_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FoodHabitsPlan_Goal_GoalId",
                        column: x => x.GoalId,
                        principalTable: "Goal",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodIntake_FoodHabitsPlan_PlanId",
                        column: x => x.PlanId,
                        principalTable: "FoodHabitsPlan",
                        principalColumn: "FoodHabitsPlanId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodPlan_FoodHabitsPlan_PlanId",
                        column: x => x.PlanId,
                        principalTable: "FoodHabitsPlan",
                        principalColumn: "FoodHabitsPlanId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodPlanDay_FoodHabitsPlan_PlanId",
                        column: x => x.PlanId,
                        principalTable: "FoodHabitsPlan",
                        principalColumn: "FoodHabitsPlanId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanId = table.Column<int>(type: "int", nullable: false),
                    NutritionistId = table.Column<int>(type: "int", nullable: false),
                    FoodHabitsPlanId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NutritionistClientPlan_FoodHabitsPlan_FoodHabitsPlanId",
                        column: x => x.FoodHabitsPlanId,
                        principalTable: "FoodHabitsPlan",
                        principalColumn: "FoodHabitsPlanId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodHabitsPlan_ClientId",
                table: "FoodHabitsPlan",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodHabitsPlan_GoalId",
                table: "FoodHabitsPlan",
                column: "GoalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NutritionistClientPlan_FoodHabitsPlanId",
                table: "NutritionistClientPlan",
                column: "FoodHabitsPlanId");
