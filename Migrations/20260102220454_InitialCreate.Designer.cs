...
namespace HealthWellbeing.Migrations
{
    ...
    [Migration("20260102220454_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthWellbeing.Models.ExercicioObjetivoFisico", b =>
                {
                    b.Property<int>("ExercicioId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ExercicioId", "ObjetivoFisicoId");

                    b.HasIndex("ObjetivoFisicoId");

                    b.ToTable("ExercicioObjetivoFisico");
                });
            ...
            modelBuilder.Entity("HealthWellbeing.Models.ExercicioTipoExercicio", b =>
                {
                    b.Property<int>("ExercicioId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ExercicioId", "TipoExercicioId");

                    b.HasIndex("TipoExercicioId");

                    b.ToTable("ExercicioTipoExercicio");
                });
            ...
            modelBuilder.Entity("HealthWellbeing.Models.HistoricoAtividade", b =>
                {
                    b.Property<int>("HistoricoAtividadeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HistoricoAtividadeId"));
            ...
            modelBuilder.Entity("HealthWellbeing.Models.PlanoExercicioExercicio", b =>
                {
                    b.Property<int>("PlanoExerciciosId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PlanoExerciciosId", "ExercicioId");

                    b.HasIndex("ExercicioId");

                    b.ToTable("PlanoExercicioExercicio");
                });
            ...
            modelBuilder.Entity("HealthWellbeing.Models.ExercicioTipoExercicio", b =>
                {
                    b.HasOne("HealthWellbeing.Models.Exercicio", "Exercicio")
                        .WithMany("ExercicioTipoExercicios")
                        .HasForeignKey("ExercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthWellbeing.Models.PlanoExercicioExercicio", b =>
                {
                    b.HasOne("HealthWellbeing.Models.Exercicio", "Exercicio")
                        .WithMany("PlanoExercicioExercicios")
                        .HasForeignKey("ExercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthWellbeing.Models.Exercicio", b =>
                {
                    ...
                    b.Navigation("ExercicioObjetivos");

                    b.Navigation("ExercicioTipoExercicios");

                    b.Navigation("HistoricoAtividades");

                    b.Navigation("PlanoExercicioExercicios");
                });
