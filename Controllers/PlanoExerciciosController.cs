...
namespace HealthWellbeing.Controllers
{
    public class PlanoExerciciosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.Exercicios = _context.Exercicio.ToList();
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PlanoExerciciosId,UtenteGrupo7Id")] PlanoExercicios planoExercicios, int[] ExerciciosSelecionados)
        {
            if (ModelState.IsValid)
            {
                ...
                planoExercicios.Exercicios = new List<Exercicio>();

                foreach (var exId in ExerciciosSelecionados)
                {
                    var exercicio = await _context.Exercicio.FindAsync(exId);
                    if (exercicio != null)
                    {
                        planoExercicios.Exercicios.Add(exercicio);
                    }
                }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["UtenteGrupo7Id"] = new SelectList(_context.UtenteGrupo7, "UtenteGrupo7Id", "UtenteGrupo7Id", planoExercicios.UtenteGrupo7Id);
            ViewBag.Exercicios = await _context.Exercicio.ToListAsync();
            return View(planoExercicios);
        }
