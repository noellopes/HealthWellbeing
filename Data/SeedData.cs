    ...
    internal class SeedData
    {
        ...
        private static void PopulateLevels(HealthWellbeingDbContext dbContext)
        {
            ...
            dbContext.Level.AddRange(new List<Level>() {
                new Level { LevelNumber = 1, LevelCategory = "Beginner", Description = "First steps in the health journey" },
                new Level { LevelNumber = 2, LevelCategory = "Beginner", Description = "Starting to build healthy routines" },
                new Level { LevelNumber = 3, LevelCategory = "Beginner", Description = "Gaining consistency in workouts" },
                new Level { LevelNumber = 4, LevelCategory = "Beginner", Description = "Steady progress in your well-being" },
                new Level { LevelNumber = 5, LevelCategory = "Beginner", Description = "End of beginner phase – solid habits established" },

                new Level { LevelNumber = 6, LevelCategory = "Intermediate", Description = "Entering the intermediate stage" },
                new Level { LevelNumber = 7, LevelCategory = "Intermediate", Description = "Developing physical endurance" },
                new Level { LevelNumber = 8, LevelCategory = "Intermediate", Description = "Improving overall performance" },
                new Level { LevelNumber = 9, LevelCategory = "Intermediate", Description = "Consolidating advanced techniques" },
                new Level { LevelNumber = 10, LevelCategory = "Intermediate", Description = "Ready for tougher challenges" },

                new Level { LevelNumber = 11, LevelCategory = "Advanced", Description = "Beginning the advanced journey" },
                new Level { LevelNumber = 12, LevelCategory = "Advanced", Description = "Mastering complex exercises" },
                new Level { LevelNumber = 13, LevelCategory = "Advanced", Description = "Excellence in cardiovascular training" },
                new Level { LevelNumber = 14, LevelCategory = "Advanced", Description = "Specializing in strength and endurance" },
                new Level { LevelNumber = 15, LevelCategory = "Advanced", Description = "Forming a complete athlete" },

                new Level { LevelNumber = 16, LevelCategory = "Expert", Description = "First expert-level achievement" },
                new Level { LevelNumber = 17, LevelCategory = "Expert", Description = "Advanced conditioning techniques" },
                new Level { LevelNumber = 18, LevelCategory = "Expert", Description = "Master of personalized routines" },
                new Level { LevelNumber = 19, LevelCategory = "Expert", Description = "A reference within the fitness community" },
                new Level { LevelNumber = 20, LevelCategory = "Expert", Description = "Established expert" },

                new Level { LevelNumber = 21, LevelCategory = "Master", Description = "Beginning the path of a master" },
                new Level { LevelNumber = 22, LevelCategory = "Master", Description = "Complete mastery across multiple disciplines" },
                new Level { LevelNumber = 23, LevelCategory = "Master", Description = "Natural leader in group workouts" },
                new Level { LevelNumber = 24, LevelCategory = "Master", Description = "An inspiration to other users" },
                new Level { LevelNumber = 25, LevelCategory = "Master", Description = "Recognized master in health and wellness" },

                new Level { LevelNumber = 26, LevelCategory = "Grandmaster", Description = "First grandmaster level" },
                new Level { LevelNumber = 27, LevelCategory = "Grandmaster", Description = "Excellence in all aspects of fitness" },
                new Level { LevelNumber = 28, LevelCategory = "Grandmaster", Description = "Deep knowledge of nutrition and exercise" },
                new Level { LevelNumber = 29, LevelCategory = "Grandmaster", Description = "A legend in the making" },
                new Level { LevelNumber = 30, LevelCategory = "Grandmaster", Description = "A fully established grandmaster" },

                new Level { LevelNumber = 31, LevelCategory = "Legendary", Description = "Entering the legendary hall" },
                new Level { LevelNumber = 32, LevelCategory = "Legendary", Description = "Legendary consistency in training" },
                new Level { LevelNumber = 33, LevelCategory = "Legendary", Description = "Outstanding long-term performance" },
                new Level { LevelNumber = 34, LevelCategory = "Legendary", Description = "A true icon of the app" },
                new Level { LevelNumber = 35, LevelCategory = "Legendary", Description = "A living fitness legend" },

                new Level { LevelNumber = 36, LevelCategory = "Mythic", Description = "Achieving mythic status" },
                new Level { LevelNumber = 37, LevelCategory = "Mythic", Description = "Superhuman strength and determination" },
                new Level { LevelNumber = 38, LevelCategory = "Mythic", Description = "A legend among legends" },
                new Level { LevelNumber = 39, LevelCategory = "Mythic", Description = "Close to the maximum level" },
                new Level { LevelNumber = 40, LevelCategory = "Mythic", Description = "Maximum level – A living myth of the app" }
