...
namespace HealthWellbeing.Data
{
    public class SeedDataGroup1
    {
        ...
        private static void PopulateTreatmentType(HealthWellbeingDbContext HealthWellbeingDbContext)
        {
            ...
            {
                new TreatmentType { Name = "Fisioterapia Geral", Description = "Sessões de fisioterapia para recuperação muscular.", EstimatedDuration = 60 },
                new TreatmentType { Name = "Massagem Relaxante", Description = "Massagem terapêutica para alívio de stress.", EstimatedDuration = 45 },
                new TreatmentType { Name = "Acupuntura", Description = "Tratamento com agulhas para equilíbrio energético.", EstimatedDuration = 40 },
                new TreatmentType { Name = "Consulta de Nutrição", Description = "Avaliação nutricional e plano alimentar personalizado.", EstimatedDuration = 50 },
                new TreatmentType { Name = "Terapia Ocupacional", Description = "Apoio para melhorar a autonomia e funções motoras.", EstimatedDuration = 60 },
                new TreatmentType { Name = "Psicoterapia Individual", Description = "Sessões com psicólogo para saúde mental e emocional.", EstimatedDuration = 50 },
                new TreatmentType { Name = "Consulta de Medicina Geral", Description = "Avaliação médica geral e prescrição de tratamentos.", EstimatedDuration = 30 },
                new TreatmentType { Name = "Reabilitação Pós-Cirúrgica", Description = "Tratamento fisioterapêutico após cirurgias.", EstimatedDuration = 70 },
                new TreatmentType { Name = "Hidroterapia", Description = "Terapia física em ambiente aquático para reabilitação.", EstimatedDuration = 60 },
                new TreatmentType { Name = "Consulta de Enfermagem", Description = "Avaliação de sinais vitais e administração de medicamentos.", EstimatedDuration = 20 },
                new TreatmentType { Name = "Sessão de Yoga Terapêutico", Description = "Exercícios de relaxamento e alongamento guiados.", EstimatedDuration = 55 },
                new TreatmentType { Name = "Terapia da Fala", Description = "Acompanhamento para melhorar a comunicação e fala.", EstimatedDuration = 40 },
                new TreatmentType { Name = "Avaliação Postural", Description = "Análise da postura e correções personalizadas.", EstimatedDuration = 35 },
                new TreatmentType { Name = "Consulta de Cardiologia", Description = "Avaliação e acompanhamento de problemas cardíacos.", EstimatedDuration = 45 },
                new TreatmentType { Name = "Reiki", Description = "Sessão energética para equilíbrio emocional e físico.", EstimatedDuration = 50 },
                new TreatmentType { Name = "Consulta de Dermatologia", Description = "Avaliação e tratamento de problemas de pele.", EstimatedDuration = 30 },
                new TreatmentType { Name = "Terapia Respiratória", Description = "Tratamentos para melhorar a função pulmonar.", EstimatedDuration = 45 },
                new TreatmentType { Name = "Consulta de Ortopedia", Description = "Avaliação de lesões e patologias ósseas ou musculares.", EstimatedDuration = 50 },
                new TreatmentType { Name = "Massagem Desportiva", Description = "Tratamento para recuperação após treino intenso.", EstimatedDuration = 40 },
                new TreatmentType { Name = "Consulta de Endocrinologia", Description = "Avaliação hormonal e metabólica.", EstimatedDuration = 45 }
